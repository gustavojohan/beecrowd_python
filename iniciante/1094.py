...
print(f"Percentual de coelhos: {(cobaias['C']/cobaias['Total'])*100:.2f} %")
print(f"Percentual de ratos: {(cobaias['R']/cobaias['Total'])*100:.2f} %")
print(f"Percentual de sapos: {(cobaias['S']/cobaias['Total'])*100:.2f} %")